...
export async function discoverBySearch(): Promise<DiscoveredRepo[]> {
  ...
  const queries = [
    ...
    'language:JavaScript is:public stars:>500 sort:stars',
    'language:Python is:public stars:>500 sort:stars',
    'language:TypeScript is:public stars:>500 sort:stars',
    'language:Java is:public stars:>300 sort:stars',
    'language:Go is:public stars:>300 sort:stars',
    'language:Rust is:public stars:>300 sort:stars',
    'language:C++ is:public stars:>300 sort:stars',
    'language:C# is:public stars:>200 sort:stars',
    'language:PHP is:public stars:>200 sort:stars',
    'language:Ruby is:public stars:>200 sort:stars',
    'language:Swift is:public stars:>200 sort:stars',
    'language:Kotlin is:public stars:>200 sort:stars',
